...
public class PortalOverlay {
    private static final ResourceLocation TEXTURE_VIGNETTE =
            Bygone.id("textures/gui/overlay/vignette.png");
    
    private static final ResourceLocation TEXTURE_PORTAL =
            Bygone.id("textures/gui/overlay/portal.png");
    ...
    public void render(GuiGraphics guiGraphics, float partialTicks) {
        ...
        boolean flag = player.portalTime > 0;
        ...
        if (!invert || alpha > 0) {
            ...
            if (alpha <= 0.37 && invert) alpha -= 0.01f;
