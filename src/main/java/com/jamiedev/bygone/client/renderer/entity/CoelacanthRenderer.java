...
public class CoelacanthRenderer extends MobRenderer<CoelacanthEntity, CoelacanthModel<CoelacanthEntity>> {
    ...
    @Override
    protected void setupRotations(@NotNull CoelacanthEntity coelacanth, @NotNull PoseStack matrixStack, float bob, float yBodyRot, float partialTick) {
        super.setupRotations(coelacanth, matrixStack, bob, yBodyRot, partialTick);
